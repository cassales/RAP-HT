...
public class HoeffdingAdaptiveTree extends HoeffdingTree {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, HoeffdingAdaptiveTree ht, SplitNode parent, int parentBranch) {
            int NodesAtBegin = ht.activeLeafNodeCount + ht.inactiveLeafNodeCount + ht.decisionNodeCount;
            ...
            int ttnodes = ht.inactiveLeafNodeCount + ht.decisionNodeCount + ht.activeLeafNodeCount;
            if (ttnodes != NodesAtBegin) {
                if (ttnodes > ht.maxNodeSize)
                    ht.maxNodeSize = ttnodes;
                ht.averageCount++;
                ht.averageNodeSize = ht.averageNodeSize + (ttnodes - ht.averageNodeSize) / ht.averageCount;
            }
        }
...
//        return super.getModelMeasurementsImpl();
        return new Measurement[]{
                ...
                new Measurement("number alternateTrees",
                        this.alternateTrees),
                new Measurement("number pruned alternateTrees",
                        this.prunedAlternateTrees),
                new Measurement("number switched alternateTrees",
