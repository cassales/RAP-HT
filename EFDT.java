...
public class EFDT extends AbstractClassifier implements MultiClassClassifier {
    ...
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
        ...
        return new EFDTSplitNode(splitTest, classObservations, size, this);
    }
    ...
    public class EFDTSplitNode extends SplitNode implements EFDTNode {
        ...
        public EFDTSplitNode(InstanceConditionalTest splitTest, double[] classObservations, int size, EFDT mainInstance) {
        ...
        protected void reEvaluateBestSplit(EFDTSplitNode node, EFDTSplitNode parent,
                                           int parentIndex) {
            int nodesAtBegin = this.mainInstance.inactiveLeafNodeCount + this.mainInstance.decisionNodeCount + this.mainInstance.activeLeafNodeCount;
            ...
            int ttnodes = this.mainInstance.inactiveLeafNodeCount + this.mainInstance.decisionNodeCount + this.mainInstance.activeLeafNodeCount;
            if (ttnodes != nodesAtBegin) {
                if (ttnodes > this.mainInstance.maxNodeSize)
                    this.mainInstance.maxNodeSize = ttnodes;
                this.mainInstance.averageCount++;
                this.mainInstance.averageNodeSize = this.mainInstance.averageNodeSize + (ttnodes - this.mainInstance.averageNodeSize) / this.mainInstance.averageCount;
            }
        }
